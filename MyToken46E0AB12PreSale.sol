...
import "./MyToken46E0AB12.sol";

contract MyToken46E0AB12PreSale {
    MyToken46E0AB12 public token;
    ...
    function MyToken46E0AB12PreSale(
        MyToken46E0AB12 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken46E0AB12(_token);
